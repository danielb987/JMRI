 ...
 */
public class ProxyDigitalIOManagerTest extends TestCase implements Manager.ManagerDataListener<Sensor>, PropertyChangeListener {
    ...
    public ProxyDigitalIOManagerTest(String s) {
        super(s);
    }

    // Main entry point
    static public void main(String[] args) {
        String[] testCaseName = {"-noloading", ProxyDigitalIOManagerTest.class.getName()};
        junit.textui.TestRunner.main(testCaseName);
    }

    // test suite from all defined tests
    public static Test suite() {
        TestSuite suite = new TestSuite(ProxyDigitalIOManagerTest.class);
        return suite;
    }
