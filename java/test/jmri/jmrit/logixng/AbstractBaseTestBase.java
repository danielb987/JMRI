...
*/
    ...
    public void testGetPrintTree() {
        ...
        _baseMaleSocket.printTree(printWriter, Base.Verbosity.Normal, Locale.ENGLISH, TREE_INDENT, new MutableInt(0));
    ...
    public void testGetPrintTreeWithStandardLocale() {
        StringWriter stringWriter = new StringWriter();
        PrintWriter printWriter = new PrintWriter(stringWriter);
        _baseMaleSocket.printTree(printWriter, Base.Verbosity.Normal, TREE_INDENT, new MutableInt(0));
        Assert.assertEquals("Tree is equal", getExpectedPrintedTree(), stringWriter.toString());
    }
    ...
    public void testGetPrintTreeFromRoot() {
        StringWriter stringWriter = new StringWriter();
        PrintWriter printWriter = new PrintWriter(stringWriter);
        _base.getRoot().printTree(printWriter, Base.Verbosity.Normal, Locale.ENGLISH, TREE_INDENT, new MutableInt(0));
    ...
    public void testGetDeepCopy() throws JmriException {
        ...
        copy.printTree(printWriter, Base.Verbosity.Normal, Locale.ENGLISH, TREE_INDENT, new MutableInt(0));
