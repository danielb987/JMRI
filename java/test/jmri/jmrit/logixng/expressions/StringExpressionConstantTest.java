...
public class StringExpressionConstantTest extends AbstractStringExpressionTestBase {
    ...
    public void testCtor() {
        ...
        Assert.assertEquals("String matches", "Get string constant \"\"", expression2.getLongDescription(Locale.ENGLISH, Base.Verbosity.Normal));
        ...
        Assert.assertNotNull("object exists", expression2);
        Assert.assertEquals("Username matches", null, expression2.getUserName());
        Assert.assertEquals("String matches", "Get string constant \"A value\"", expression2.getLongDescription(Locale.ENGLISH, Base.Verbosity.Normal));
        ...
        Assert.assertEquals("String matches", "Get string constant \"Some other value\"", expression2.getLongDescription(Locale.ENGLISH, Base.Verbosity.Normal));
    ...
    public void testLongDescription() {
        Assert.assertEquals("String matches", "Get string constant \"Something\"", _base.getLongDescription(Locale.ENGLISH, Base.Verbosity.Normal));
    }
