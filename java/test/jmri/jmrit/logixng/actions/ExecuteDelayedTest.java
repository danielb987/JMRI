...
public class ExecuteDelayedTest extends AbstractDigitalActionTestBase {
    ...
    public void testDescription() throws ParserException {
        ...
        Assert.assertEquals("strings are equal", "Execute A after 0 milliseconds. Ignore on repeat", a2.getLongDescription(Base.Verbosity.Normal));
        a2.setDelay(26);
        a2.setUnit(TimerUnit.Minutes);
        a2.setResetIfAlreadyStarted(true);
        a2.setUseIndividualTimers(false);
        Assert.assertEquals("strings are equal", "Execute A after 26 minutes. Reset on repeat", a2.getLongDescription(Base.Verbosity.Normal));
        ...
        Assert.assertEquals("strings are equal", "Execute A after 4 hours. Ignore on repeat. Use individual timers", a2.getLongDescription(Base.Verbosity.Normal));
        a2.setDelayAddressing(NamedBeanAddressing.Direct);
        a2.setDelay(4);
        a2.setUnit(TimerUnit.Hours);
        a2.setResetIfAlreadyStarted(true);
        a2.setUseIndividualTimers(true);
        Assert.assertEquals("strings are equal", "Execute A after 4 hours. Reset on repeat. Use individual timers", a2.getLongDescription(Base.Verbosity.Normal));
        a2.setDelayAddressing(NamedBeanAddressing.Formula);
        a2.setDelayFormula("delay*2");
        a2.setUnit(TimerUnit.Hours);
        a2.setResetIfAlreadyStarted(false);
        a2.setUseIndividualTimers(true);
        Assert.assertEquals("strings are equal", "Execute A after by formula delay*2 in unit Hours. Ignore on repeat. Use individual timers", a2.getLongDescription(Base.Verbosity.Normal));
        a2.setDelayAddressing(NamedBeanAddressing.LocalVariable);
        a2.setDelayLocalVariable("myVar");
        a2.setUnit(TimerUnit.Hours);
        a2.setResetIfAlreadyStarted(false);
        a2.setUseIndividualTimers(true);
        Assert.assertEquals("strings are equal", "Execute A after by local variable myVar in unit Hours. Ignore on repeat. Use individual timers", a2.getLongDescription(Base.Verbosity.Normal));
        a2.setDelayAddressing(NamedBeanAddressing.Reference);
        a2.setDelayReference("{IM1}");
        a2.setUnit(TimerUnit.Hours);
        a2.setResetIfAlreadyStarted(false);
        a2.setUseIndividualTimers(true);
        Assert.assertEquals("strings are equal", "Execute A after by reference {IM1} in unit Hours. Ignore on repeat. Use individual timers", a2.getLongDescription(Base.Verbosity.Normal));
    }
