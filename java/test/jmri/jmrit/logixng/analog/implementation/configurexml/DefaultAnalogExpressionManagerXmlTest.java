...
public class DefaultAnalogExpressionManagerXmlTest {
    ...
    public void testLoad() {
        ...
        e2.setAttribute("class", "jmri.jmrit.logixng.analog.expressions.configurexml.AnalogExpressionMemoryXml");
        e.addContent(e2);
        ...
        e = new Element("logixngAnalogExpressions");
        e2 = new Element("existing_class");
        e2.setAttribute("class", "jmri.jmrit.logixng.analog.implementation.configurexml.DefaultAnalogExpressionManagerXmlTest$PrivateConstructorXml");
        e.addContent(e2);
        b.loadExpressions(e);
        ...
        e = new Element("logixngAnalogExpressions");
        e2 = new Element("existing_class");
        e2.setAttribute("class", "jmri.jmrit.logixng.analog.implementation.configurexml.DefaultAnalogExpressionManagerXmlTest$ThrowExceptionXml");
        e.addContent(e2);
        b.loadExpressions(e);
        JUnitAppender.assertErrorMessage("cannot create constructor");
...
//        System.out.format("Class name: %s%n", PrivateConstructorXml.class.getName());
    ...
    public void testStore() {
        ...
        b.store(manager);
        JUnitAppender.assertErrorMessage("Cannot load configuration adapter for jmri.jmrit.logixng.analog.implementation.configurexml.DefaultAnalogExpressionManagerXmlTest$MyAnalogExpression");
        JUnitAppender.assertErrorMessage("Cannot store configuration for jmri.jmrit.logixng.analog.implementation.configurexml.DefaultAnalogExpressionManagerXmlTest$MyAnalogExpression");
    }
