...
public class TimeProvider_InstanceInitializer extends AbstractInstanceInitializer {
    ...
    public <T> Object getDefault(Class<T> type) {
        ...
        if (type == TimeProviderPreferences.class) {
            return new DefaultTimeProviderPreferences();
        }
