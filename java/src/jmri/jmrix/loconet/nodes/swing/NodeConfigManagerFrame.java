...
//    protected int nodeType = LnNode.SMINI; // Node type - default SMINI
     ...
     * Constructor method
     */
    public NodeConfigManagerFrame(LocoNetSystemConnectionMemo memo) {
        super();
        _memo = memo;
        curFrame = this;
    ...
    public void initComponents() {
        ...
        setTitle(Bundle.getMessage("ConfigureNodesWindowTitle"));  // NOI18N
        setSize(500, 150);
...
//        curNode.setcmriNodeDesc(nodeDescription.getText());
    ...
    public void deleteNodeButtonActionConfirm() {
        ...
        if (JOptionPane.OK_OPTION == JOptionPane.showConfirmDialog(
            ...
            // delete this node
//            _memo.getLnTrafficController().deleteNode(deleteNodeAddress);
