 ...
 */
public class ActionClearSlotsXml extends jmri.jmrit.logixng.configurexml.StoreAndLoadXml {

    public ActionClearSlotsXml() {
    }
    ...
    public boolean load(Element shared, ImportData importData) throws JmriConfigureXmlException {     // Test class that inherits this class throws exception
        ...
        ActionClearSlots h = new ActionClearSlots(sys, uname, null);
...
//    private final static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ActionClearSlotsXml.class);
}
