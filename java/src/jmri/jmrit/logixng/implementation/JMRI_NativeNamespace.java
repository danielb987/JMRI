...
/**
 * The namespace for the InstanceManager.
 */
public class JMRI_NativeNamespace implements Namespace, PropertyChangeListener, VetoableChangeListener {
...
*/
    ...
    private final static Logger log = LoggerFactory.getLogger(JMRI_NativeNamespace.class);
