...
/**
 * A manager for a LogixNG Type
 * 
 * @author Dave Duchamp       Copyright (C) 2007
 * @author Daniel Bergqvist   Copyright (C) 2018
 */
public interface TypeManager extends Manager<Type> {
     ...
     * {@inheritDoc}
     * 
     * The sub system prefix for the TypeManager is
     * {@link #getSystemNamePrefix() } and "Y";
     * <P>
     * The sub letter comes from tYpe since the letter T is for table.
     */
    @Override
    public default String getSubSystemNamePrefix() {
        return getSystemNamePrefix() + "Y";
    }
    
    /**
     * Delete Type by removing it from the manager.
     *
     * @param x the Type to delete
     */
    void deleteType(Type x);
