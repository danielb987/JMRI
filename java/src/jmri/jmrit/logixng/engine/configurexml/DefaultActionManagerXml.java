...
*/
    ...
    protected void replaceActionManager() {
        if (InstanceManager.getDefault(jmri.jmrit.logixng.ActionManager.class).getClass().getName()
                .equals(DefaultActionManager.class.getName())) {
            return;
        }
        // if old manager exists, remove it from configuration process
        if (InstanceManager.getNullableDefault(jmri.jmrit.logixng.ActionManager.class) != null) {
            ConfigureManager cmOD = InstanceManager.getNullableDefault(jmri.ConfigureManager.class);
            if (cmOD != null) {
                cmOD.deregister(InstanceManager.getDefault(jmri.jmrit.logixng.ActionManager.class));
            }
    ...
    public int loadOrder() {
        return InstanceManager.getDefault(jmri.jmrit.logixng.ActionManager.class).getXMLOrder();
    }
