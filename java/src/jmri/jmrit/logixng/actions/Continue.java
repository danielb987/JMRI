 ...
 */
public class Continue extends AbstractDigitalAction {

    public Continue(String sys, String user) {
        super(sys, user);
    }
    ...
    public Base getDeepCopy(Map<String, String> systemNames, Map<String, String> userNames) throws JmriException {
        ...
        Continue copy = new Continue(sysName, userName);
    ...
    public String getShortDescription(Locale locale) {
        return Bundle.getMessage(locale, "Continue_Short");
    }
