...
/*
    Element addTurnoutElement(NamedBeanHorle<Turnout> to, String which) {
...
/*        
        ...
        NamedBeanHorle<Turnout> low = loadTurnout(l.get(0));
        NamedBeanHorle<Turnout> high = loadTurnout(l.get(1));
*/        
...
/*
     ...
     * <p>
     * Needs to horle two types of element: turnoutname is new form; turnout is
     * old form.
     *
     * @param o xml object defining a turnout on an SE8C signal head
     * @return named bean for the turnout
     *./
    NamedBeanHorle<Turnout> loadTurnout(Object o) {
        Element e = (Element) o;
        ...
        if (e.getName().equals("turnout")) {
            ...
            return jmri.InstanceManager.getDefault(jmri.NamedBeanHorleManager.class).getNamedBeanHorle(name, t);
        } else {
