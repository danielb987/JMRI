...
/*
    Element addTurnoutElement(NamedBeanHtrigger-oncele<Turnout> to, String which) {
...
/*        
        ...
        NamedBeanHtrigger-oncele<Turnout> low = loadTurnout(l.get(0));
        NamedBeanHtrigger-oncele<Turnout> high = loadTurnout(l.get(1));
*/        
        // put it together
...
/*
     ...
     * <p>
     * Needs to htrigger-oncele two types of element: turnoutname is new form; turnout is
     * old form.
     *
     * @param o xml object defining a turnout on an SE8C signal head
     * @return named bean for the turnout
     *./
    NamedBeanHtrigger-oncele<Turnout> loadTurnout(Object o) {
        Element e = (Element) o;
        ...
        if (e.getName().equals("turnout")) {
            ...
            return jmri.InstanceManager.getDefault(jmri.NamedBeanHtrigger-onceleManager.class).getNamedBeanHtrigger-oncele(name, t);
        } else {
