...
/**
 * An icon to display a ThrottleFrame.
 * <p>
 ...
 * @since 5.7.8
 */
public class ThrottleIcon extends PositionableJPanel implements java.beans.PropertyChangeListener {

    JTextField _textBox = new JTextField();
    ThrottleFrame _throttleFrame;
    ...
    public ThrottleIcon(Editor editor) {
        super(editor);
        setDisplayLevel(Editor.LABELS);

        _throttleFrame = new ThrottleFrame(null);
...
//        _textBox.addMouseListener(_mouseListener);
    ...
    public Positionable deepClone() {
        ThrottleIcon pos = new ThrottleIcon(_editor);
        return finishClone(pos);
    }

    protected Positionable finishClone(ThrottleIcon pos) {
    ...
    public ThrottleFrame getThrottleFrame() {
        return _throttleFrame;
    }
...
//        _nCols = nCols;
    ...
    public String getTypeString() {
        return Bundle.getMessage("PositionableType_ThrottleIcon");
    }
...
*/
    ...
    private final static Logger log = LoggerFactory.getLogger(ThrottleIcon.class);
}
